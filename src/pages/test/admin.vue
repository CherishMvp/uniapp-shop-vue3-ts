...
const openPoup = async (goods_id: string, type: string) => {
  ...
  <uni-popup ref="editPoup" background-color="#fafafa">
    <div class="poup_wrap">
      <scroll-view scroll-y class="scroll_view">
        <div class="header">编辑商品</div>
        <div class="poup_content">
          <div class="line">
            <uni-forms ref="editFormRef" :modelValue="productInfo">
              ...
              <uni-forms-item label="规格" name="spec">
                <uni-data-checkbox v-model="productInfo.spec" multiple :localdata="specList" />
              </uni-forms-item>
              ...
              <view style="background-color: #bfa; color: #000" @click="onPictureChange"
                >上传商品图</view
              >
            </uni-forms>
          </div>
    ...
    <div class="poup_content">
      <uni-forms :modelValue="productInfo">
        <uni-forms-item label="分类" name="categoryName">
          <uni-data-select
            v-model="productInfo.categoryName"
            :localdata="range"
        ...
        <uni-forms-item label="库存" name="inventory">
          <uni-easyinput type="number" v-model="productInfo.inventory" placeholder="请输入库存" />
        </uni-forms-item>
        <view style="background-color: #bfa; color: #000" @click="onPictureChange">上传商品图</view>
      </uni-forms>
